...
public class DuplicateLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("NarendranDuplicateCompName");
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("NarendranDuplicateFirstName");
		driver.findElement(By.name("submitButton")).click();
		Thread.sleep(10000);
